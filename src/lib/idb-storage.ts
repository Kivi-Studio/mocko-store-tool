 ...
 *
 * We use IndexedDB rather than localStorage because designs embed uploaded
 * screenshots as base64 data URLs, which quickly exceed the ~5 MB localStorage
 * quota. IndexedDB comfortably handles much larger payloads.
 *
